...
plot(x = SubConjunto$Fecha, y = SubConjunto$Voltage, type = "s", main = "", xlab = "datetime", ylab = "Voltaje")
...
plot(x = SubConjunto$Fecha, y = SubConjunto$Global_reactive_power, type = "s", main = "", xlab = "datetime", ylab = names(SubConjunto)[4])
dev.off()